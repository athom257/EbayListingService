...
public class ShippingDetailsType {
    ...
    public void setShippingServiceOptions(ShippingServiceOptionsType shippingServiceOptionsType) {
        if (shippingServiceOptions == null) {
            shippingServiceOptions = new ArrayList<ShippingServiceOptionsType>();
    ...
    public void setExcludeShipToLocation() {
            excludeShipToLocation = new ArrayList<String>();
            excludeShipToLocation.add("US Protectorates");
            excludeShipToLocation.add("Alaska/Hawaii");
            excludeShipToLocation.add("APO/FPO");
            excludeShipToLocation.add("Africa");
            excludeShipToLocation.add("Asia");
            excludeShipToLocation.add("Middle East");
            excludeShipToLocation.add("Southeast Asia");
            excludeShipToLocation.add("Central America and Caribbean");
            excludeShipToLocation.add("South America");
            excludeShipToLocation.add("PO Box");
            excludeShipToLocation.add("Europe");
            excludeShipToLocation.add("Oceania");
            excludeShipToLocation.add("North America");
    }
